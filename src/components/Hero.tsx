...
const Hero = () => (
  <section className="relative h-[90vh] bg-[#f8f8f3] overflow-hidden section-animate">
    <div className="absolute inset-0 bg-gradient-to-r from-[rgba(15,76,117,0.1)] to-transparent z-10"></div>
    <div className="grid grid-cols-1 md:grid-cols-2 h-full">
      <div className="flex flex-col justify-center items-start p-12 lg:p-16 z-20">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-tight text-blue-800 tracking-tight">
        ...
        <button className="mt-8 px-10 py-4 rounded-full bg-blue-800 text-white font-medium btn-animate animate-[fadeIn_0.6s_ease-in-out_1s_both] shadow-md">
          Call Now

...
const About = () => (
  <section id="about" className="py-24 bg-[var(--primary-light)] relative section-animate">
    ...
    <div className="container mx-auto max-w-5xl px-6">
      <h2 className="text-3xl md:text-5xl font-serif font-semibold text-blue-800 mb-8 text-center">About All Hours Plumbing</h2>
      ...
      <div className="bg-white bg-opacity-50 backdrop-blur-sm rounded-xl p-8 md:p-12 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-full bg-blue-800 text-white">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="font-serif text-xl font-medium mb-2 text-[var(--text-primary)]">24/7 Availability</h3>
            <p className="text-[var(--text-secondary)]">Always here when you need us, day or night</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-serif text-xl font-medium mb-2 text-[var(--text-primary)]">Emergency Response</h3>
            <p className="text-[var(--text-secondary)]">Quick response to urgent plumbing issues</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-[var(--text-secondary)]">Professional service for all plumbing needs</p>
          </div>
        </div>
        
        <div className="text-center">
          <button className="px-8 py-3 rounded-full bg-blue-800 text-white font-medium btn-animate shadow-sm">
            Contact Us Now
          </button>
        </div>
      </div>

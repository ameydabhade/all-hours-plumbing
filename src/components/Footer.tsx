    ...
    <div className="container mx-auto max-w-6xl px-6">
      <div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-1">
          <h2 className="font-serif text-xl font-semibold text-blue-800 mb-6">All Hours Plumbing</h2>
          <p className="text-[var(--text-secondary)] mb-6">Available 24/7 for all your plumbing needs in Yulee and surrounding areas.</p>
          <div className="flex space-x-4">
            <a href="#" className="bg-blue-800 text-white p-2 rounded-full hover:bg-[var(--accent)] transition-colors">
        ...
        <div className="md:col-span-1">
          <h3 className="font-serif text-lg font-medium text-blue-800 mb-4">Quick Links</h3>
        ...
        <div className="md:col-span-1">
          <h3 className="font-serif text-lg font-medium text-blue-800 mb-4">Contact Info</h3>
          <address className="not-italic text-[var(--text-secondary)] space-y-2">
            <p>85633 Alene Rd</p>
            <p>Yulee, FL 32097</p>
            <p className="mt-4">(904) 225-5555</p>
            <p>info@allhoursplumbing.com</p>
          </address>
        </div>
        
        <div className="md:col-span-1">
          <h3 className="font-serif text-lg font-medium text-blue-800 mb-4">Business Hours</h3>
          <ul className="text-[var(--text-secondary)] space-y-2">
            <li className="flex justify-between"><span>Monday-Friday:</span> <span>24/7</span></li>
            <li className="flex justify-between"><span>Saturday:</span> <span>24/7</span></li>
            <li className="flex justify-between"><span>Sunday:</span> <span>24/7</span></li>
            <li className="mt-4">Always Available for Emergencies</li>
          </ul>
        </div>
      </div>
      ...
      <div className="py-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-sm text-[var(--text-secondary)]">
        <div className="mb-4 md:mb-0">
          &copy; {new Date().getFullYear()} All Hours Plumbing. All rights reserved.
        </div>
